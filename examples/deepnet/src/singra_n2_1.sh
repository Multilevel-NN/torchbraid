#!/bin/bash
#SBATCH --job-name=lang-model-2-1
#SBATCH --time=90:99:00
#SBATCH --output=ml_multi_2-1.out
#SBATCH --error=ml_multi_2-1.err
...
mpirun -n 2 python main.py --lr 5e-4 --percent-data=$PDATA --steps 128 --epochs=$EPOCHS --batch-size=$BATCH_SIZE --lp-max-levels "(1, 1)" --lp-bwd-max-iters 1 --lp-fwd-max-iters 1 --lp-cfactor 4 --lp-print-level 0 --lp-braid-print-level 0 --Tf 1 --log-interval 2 --seq-len 128  --model_dimension 768
