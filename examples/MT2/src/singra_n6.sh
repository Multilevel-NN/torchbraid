#!/bin/bash
#SBATCH --job-name=MT6_3_2_1
#SBATCH --output=mt6_3_2_1.out
#SBATCH --error=mt6_3_2_1.err
...
mpirun -n 6 python main.py --batch-size 8 --epochs 1000000 --d_model 512 --dropout .1 --gradient_accumulation 16 --initialize_parameters --num_warmup_steps 8000 --tokenization unigram --vocab_size 8000 --steps 6 --Tf 6. --lp-max-levels 2 --lp-cfactor 3 --lp-fwd-max-iters 3 --lp-bwd-max-iters 2 --seed 1 --num_training_batches 20000
