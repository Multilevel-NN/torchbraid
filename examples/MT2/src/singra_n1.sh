#!/bin/bash
#SBATCH --job-name=MT1_3_2_2
#SBATCH --output=mt1_3_2_2.out
#SBATCH --error=mt1_3_2_2.err
...
mpirun -n 1 python main.py --batch-size 8 --epochs 1000000 --d_model 512 --dropout 0.1 --gradient_accumulation 16 --initialize_parameters --num_warmup_steps 8000 --tokenization unigram --vocab_size 8000 --steps 6 --Tf 6. --lp-max-levels 2 --lp-cfactor 3 --lp-fwd-max-iters 3 --lp-bwd-max-iters 2 --seed 2 --num_training_batches 20000 --lp-print-level 0 --lp-braid-print-level 0
