#!/bin/bash
#SBATCH --job-name=vit-timing
#SBATCH --time=90:99:00
#SBATCH --output=vit-timing.out
#SBATCH --error=vit-timing.err
...
# BATCH_SIZE=256
# 128 batch for 32 steps fits all 
# 32 fits 128 on n=1; compared against 64 
# 64 for 64 layers on n=1, comapred against 128
BATCH_SIZE=128
...
mpirun -n 8 python main.py --lr 5e-4 --percent-data=$PDATA --steps 64 --epochs=$EPOCHS --batch-size=$BATCH_SIZE --lp-max-levels "(1, 2)" --lp-bwd-max-iters 1 --lp-fwd-max-iters 1 --lp-cfactor 4 --lp-print-level 0 --lp-braid-print-level 0 --Tf 1 --log-interval 1
