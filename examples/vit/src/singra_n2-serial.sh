#!/bin/bash
#SBATCH --job-name=vit-2-serial
#SBATCH --time=90:99:00
#SBATCH --output=vit_2_ti-serial.out
#SBATCH --error=vit_2_ti-serial.err
...
# For tinyimagenet
mpirun -n 2 python main.py --lr 5e-5 --percent-data=$PDATA --steps 12 --epochs=$EPOCHS --batch-size=$BATCH_SIZE --lp-max-levels "(1, 1)" --lp-bwd-max-iters 1 --lp-fwd-max-iters 1 --lp-cfactor 3 --lp-print-level 1 --lp-braid-print-level 1 --Tf .12 --log-interval 1
