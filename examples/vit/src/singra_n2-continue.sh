#!/bin/bash
#SBATCH --job-name=vit-continue-serial
#SBATCH --time=90:99:00
#SBATCH --output=vit-cont.out
#SBATCH --error=vit-cont.err
...
mpirun -n 2 python main-continuing.py --lr 5e-4 --percent-data=$PDATA --steps 32 --epochs=$EPOCHS --batch-size=$BATCH_SIZE --lp-max-levels "(1, 1)" --lp-bwd-max-iters 1 --lp-fwd-max-iters 1 --lp-cfactor 4 --lp-print-level 0 --lp-braid-print-level 0 --Tf 1 --log-interval 1
