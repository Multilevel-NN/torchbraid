#!/bin/bash
#SBATCH --job-name=gpt-2-parallel
#SBATCH --time=90:99:00
#SBATCH --output=gpt-2-parallel.out
#SBATCH --error=gpt-2-parallel.err
...
mpirun -n 2 python main.py --lr 1e-4 --steps 48 --batch-size=32 --lp-max-levels "(1, 2)" --lp-bwd-max-iters 1 --lp-fwd-max-iters 1 --lp-cfactor 4 --lp-print-level 0 --lp-braid-print-level 0 --Tf 1 --log-interval 8 --seq-len 512
