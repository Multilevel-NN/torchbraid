...
#mpirun -n 2 python main.py --lr 5e-5 --percent-data=$PDATA --steps 32 --epochs=$EPOCHS --batch-size=$BATCH_SIZE --lp-max-levels "(1, 2)" --lp-bwd-max-iters 1 --lp-fwd-max-iters 1 --lp-cfactor 4 --lp-print-level 1 --lp-braid-print-level 1 --Tf 1 --log-interval 1 --seq-len 96


# --------------------------------------------------------------

mpirun -n 2 python main.py --lr 5e-5 --percent-data=$PDATA --steps 32 --epochs=$EPOCHS --batch-size=$BATCH_SIZE --lp-max-levels "(1, 1)" --lp-bwd-max-iters 1 --lp-fwd-max-iters 1 --lp-cfactor 4 --lp-print-level 1 --lp-braid-print-level 1 --Tf 1 --log-interval 1 --seq-len 96
