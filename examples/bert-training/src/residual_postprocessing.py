...
def main():
  ...
  # Load tokenizer for the vocab size 
  ...
  criterion = nn.CrossEntropyLoss(ignore_index=-100)
  for epoch in range(0, 30001, 1000):
    # Grab checkpoint 
    checkpoint = torch.load(f'bert-save-2-serial/model_checkpoint_{rank}_batch_idx={epoch}')
    ...
    segment_label = checkpoint['segment_label']
